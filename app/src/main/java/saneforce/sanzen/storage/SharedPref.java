...
// LogIN Data
   ...
   // public static final String DoctorRemainingShownDate = "DoctorRemainingShownDate";
    ...
    public static final String TERR_DCR_NEED = "Terr_DCR_Need";
    ...
    public static void InsertLogInData(Context context, JSONObject jsonObject) {
        try {
            ...
            editor.putString(TERR_DCR_NEED,jsonObject.optString("Terr_DCR_Need"));
            editor.apply();
    ...
    public static void setTodayTPChemists(Context context, String chemistsCodes) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SP_NAME, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(TodayTPChemists, chemistsCodes);
        editor.apply();
    }
...
public static void addVisitedDoctor(Context context, String custCode) {
    ...
    public static String getTerrBasedDcr(Context context){
        return context.getSharedPreferences(SP_NAME, MODE_PRIVATE).getString(TERR_DCR_NEED,"");
    }
