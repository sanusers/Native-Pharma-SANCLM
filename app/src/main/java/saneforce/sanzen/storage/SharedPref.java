...
// LogIN Data
    ...
    public static final String CHE_ARRAY = "ChmistArray";
    ...
    public static void InsertLogInData(Context context, JSONObject jsonObject) {
        try {
            ...
            editor.putString(S3_BUCKET_NEED, jsonObject.getString("S3BucketNeed"));    //S3BucketNeed
            editor.apply();
    ...
    public static void saveCheArray(Context context, JSONArray jsonArray) {

        try {
            sharedPreferences = context.getSharedPreferences(SP_NAME,MODE_PRIVATE);
            editor = sharedPreferences.edit();
            String stringArray = jsonArray.toString();
            editor.putString(CHE_ARRAY,stringArray);
            editor.apply();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    public static String getCheArray(Context context) {
        return context.getSharedPreferences(SP_NAME, MODE_PRIVATE).getString(CHE_ARRAY, "");
    }
