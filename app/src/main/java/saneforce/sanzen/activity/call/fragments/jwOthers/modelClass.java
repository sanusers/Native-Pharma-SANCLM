...
public class modelClass {
        ...
        public modelClass(String docName, String callsDateTime, String docNameID) {
            DocName = docName;
            CallsDateTime = callsDateTime;
            DocNameID = docNameID;
        }

        public modelClass(String TranslNo, String ADetSLNo, String docName, String docCode, String callsDateTime, String dcrDate, String docNameID, String product, String input) {
