...
public class UnlistedDoctorAddition extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        unlistedadditionbinding.btnUnlstsave.setOnClickListener(new SafeClickListener() {
            @Override
            public void onSafeClick(View view) {
                unlistedadditionbinding.btnUnlstsave.setEnabled(false);
                if (unlistedadditionbinding.edtDctr.getText().toString().isEmpty()) {
                    commonUtilsMethods.showToastMessage(UnlistedDoctorAddition.this, getResources().getString(R.string.fill) + " " + getResources().getString(R.string.name));
