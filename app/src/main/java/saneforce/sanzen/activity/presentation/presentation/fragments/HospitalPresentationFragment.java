...
public class HospitalPresentationFragment extends Fragment {
    ...
    public HospitalPresentationFragment(ShowSideScreenListener showSideScreenListener) {
    ...
    public void populateAdapter() {
        if(!savedPresentation.isEmpty()) {
            ...
            PresentationAdapter presentationAdapter = new PresentationAdapter(requireContext(), savedPresentation, "custom", SharedPref.getHospCaption(requireContext()), showCustomersClickListener);
