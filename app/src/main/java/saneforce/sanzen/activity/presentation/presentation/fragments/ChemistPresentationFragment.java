...
public class ChemistPresentationFragment extends Fragment {
    ...
    public ChemistPresentationFragment(ShowSideScreenListener showSideScreenListener) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        savedPresentation = presentationDataDao.getPresentations("2");
    }
...
//            intent.putExtra(CustomerSelectionActivity.CUSTOMER_TYPE, Constants.CHEMIST_MAS);
    ...
    public void populateAdapter() {
        if(!savedPresentation.isEmpty()) {
            ...
            PresentationAdapter presentationAdapter = new PresentationAdapter(requireContext(), savedPresentation, "custom", SharedPref.getChmCap(requireContext()), showCustomersClickListener);
