...
//            saveTpLocal(modelClasses, day, monthYear, "0");
    ...
    public void changeApprovalBtnStateOneBuild(ArrayList<OneBuildModelClass> arrayList) {
        ...
        binding.tpSendToApproval.setEnabled(wholeMonthTpCompleted && (status.equals("0") || status.equals("-1") || status.equals("2")));
...
//                                        SessionsObj.put("Cip", Cip);
    ...
    public String textBuilder_OB(List<OneBuildModelClass.SessionList.SubClass> sessionLists, boolean codeOrName) {
