...
public class DoctorProfileView extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LinearLayout ResEdit = findViewById(R.id.res_edit);
        Class<?> source = (Class<?>) getIntent().getSerializableExtra("source");
        if(SharedPref.getProfilingNeed(DoctorProfileView.this).equalsIgnoreCase("0") && source == Res_sidescreenAdapter.class){
            ResEdit.setVisibility(View.VISIBLE);
        }else{
            ResEdit.setVisibility(View.GONE);
        }
...
// 2. Ippo condition-padi hide pannuvom
            if (CusType.equals("C")) {
                ...
                activityDoctorProfileViewBinding.tvGender.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvTagGender.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvPhone.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvTagPhone.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvDob.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvTagDob.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvWedDate.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvTagWedDate.setVisibility(View.GONE);
                ...
                activityDoctorProfileViewBinding.tvWedDate.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvTagWedDate.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvMob.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvTagMob.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvEmail.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvTagEmail.setVisibility(View.GONE);
            } else if (CusType.equalsIgnoreCase("U")) {
                activityDoctorProfileViewBinding.tvGender.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvTagGender.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvPhone.setVisibility(View.GONE);
                activityDoctorProfileViewBinding.tvTagPhone.setVisibility(View.GONE);
            ...
            switch (CusType) {
                case "D":
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        JSONObject doctorProfileObject = jsonArray.optJSONObject(i);
                        if (doctorProfileObject == null) continue;
                        String code = doctorProfileObject.optString("Code"); // <-- doctor code from DB

                        if (!Doc_code.equalsIgnoreCase(code)) {
                            continue; // not this doctor
                        }
                        ...
                        String cls = doctorProfileObject.optString("Doc_Class_ShortName");
                        ...
                        activityDoctorProfileViewBinding.tvClass.setText(setValue(cls));
                ...
                case "C":
                    ...
                    if (chmJsonArray != null && chmJsonArray.length() > 0) {
                        ...
                        for (int i = 0; i < chmJsonArray.length(); i++) {

                            JSONObject chmJsonArrayJSONObject = chmJsonArray.optJSONObject(i);
                            if (chmJsonArrayJSONObject == null) continue;

                            String code = chmJsonArrayJSONObject.optString("Code"); // chemist code key
                ...
                case "S":
                    ...
                    if (stkJsonArray != null && stkJsonArray.length() > 0) {
                        ...
                        for (int i = 0; i < stkJsonArray.length(); i++) {

                            JSONObject stkJsonArrayJSONObject = stkJsonArray.optJSONObject(i);
                            if (stkJsonArrayJSONObject == null) continue;

                            String code = stkJsonArrayJSONObject.optString("Code"); // stockist code key
                ...
                case "U":
                    ...
                    if (unlistJsonArray != null && unlistJsonArray.length() > 0) {
                        ...
                        for (int i = 0; i < unlistJsonArray.length(); i++) {

                            JSONObject unlistJsonArrayJSONObject = unlistJsonArray.optJSONObject(i);
                            if (unlistJsonArrayJSONObject == null) continue;

                            String code = unlistJsonArrayJSONObject.optString("Code"); // unlisted doctor code
                            ...
                            if (unlistDobObj != null) {
                                ...
                                if (!fullDate.contains("1900")) {
                                    unlistDob = TimeUtils.GetConvertedDate(
                                            TimeUtils.FORMAT_1,
                                            TimeUtils.FORMAT_5,
                                            fullDate
                                    );
                            ...
                            String unlistDow = "";
                            JSONObject unlistDowObj = unlistJsonArrayJSONObject.optJSONObject("UnlstDOW");
                            if (unlistDowObj != null) {
                                String fullDate = unlistDowObj.optString("date");
                                if (!fullDate.contains("1900")) {
                                    unlistDow = TimeUtils.GetConvertedDate(
                                            TimeUtils.FORMAT_1,
                                            TimeUtils.FORMAT_5,
                                            fullDate
                                    );
