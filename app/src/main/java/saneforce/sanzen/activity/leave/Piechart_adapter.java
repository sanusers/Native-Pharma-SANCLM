...
//    ArrayList<Integer> colors3 = new ArrayList<>();
    ...
    public Piechart_adapter(Context context, ArrayList<Leave_modelclass> chart_list) {
        ...
        clrs.add(Color.rgb(217, 217, 217));
        clrs.add(ContextCompat.getColor(context, R.color.green_60));
        colors.add(clrs);

        clrs = new ArrayList<>();
        clrs.add(Color.rgb(217, 217, 217));
        clrs.add(ContextCompat.getColor(context, R.color.red_60));
        colors.add(clrs);

        clrs = new ArrayList<>();
        clrs.add(Color.rgb(217, 217, 217));
        clrs.add(ContextCompat.getColor(context, R.color.blue_60));
        colors.add(clrs);

        clrs = new ArrayList<>();
        clrs.add(Color.rgb(217, 217, 217));
        clrs.add(ContextCompat.getColor(context, R.color.yellow_60));
        colors.add(clrs);

        clrs = new ArrayList<>();
        clrs.add(Color.rgb(217, 217, 217));
        clrs.add(ContextCompat.getColor(context, R.color.pink_60));
        colors.add(clrs);

        clrs = new ArrayList<>();
        clrs.add(Color.rgb(217, 217, 217));
        clrs.add(ContextCompat.getColor(context, R.color.colorPrimaryDark));
        colors.add(clrs);

        clrs = new ArrayList<>();
        clrs.add(Color.rgb(217, 217, 217));
        clrs.add(ContextCompat.getColor(context, R.color.brown_60));
        colors.add(clrs);

        clrs = new ArrayList<>();
        clrs.add(Color.rgb(217, 217, 217));
        clrs.add(ContextCompat.getColor(context, R.color.purple_200));
        colors.add(clrs);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Chartview(holder.pieChart, pie_value.getL_type(), pie_value.getEligable(), pie_value.getAvaolable(), pie_value.getTakenleave(), pie_value.getTotalApplied(), holder.c_val, holder.c_val_tol, holder.ltype_name, pie_value.getLtype(),
...
//pie_value.getEligable(),pie_value.getTakenleave()
    ...
    public void Chartview(PieChart chart, String L_Available, String L_Elgable, String L_taken, String taken,String TotalApplied, TextView c_val, TextView c_val_tol, TextView ltype_name, String pie_value,
...
//            colors.add(Color.rgb(0, 198, 137));
        ...
        if (entitlementDisabled) {
           int Apply_dates = (TotalApplied == null || TotalApplied.isEmpty()) ? 0 : Integer.parseInt(TotalApplied);
           // int Apply_dates = entitlementDisabled ? Integer.parseInt(TotalApplied) : Integer.parseInt(taken);
