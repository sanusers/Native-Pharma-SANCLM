...
public class WorkPlanFragment extends Fragment implements View.OnClickListener {
    ...
    private String CheckInOutNeed, STPNeed, STPBasedMTP, STPBasedDCR, TPNeed, TPBasedDCR, TPDCRDeviation;
