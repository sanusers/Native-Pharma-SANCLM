...
public class TpApprovalDetailedAdapter extends RecyclerView.Adapter<TpApprovalDetailedAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TpApprovalDetailedAdapter.ViewHolder holder, int position) {
            ...
            tpClickedList.add(new TpDetailedModel(tpDetailedList.get(position).getDayNo(), tpDetailedList.get(position).getWtName(), tpDetailedList.get(position).getHqName(),tpDetailedList.get(position).getClusterName(), tpDetailedList.get(position).getFWFlg(), tpDetailedList.get(position).getDayRemarks(), tpDetailedList.get(position).getDrName(), tpDetailedList.get(position).getChemistName(), tpDetailedList.get(position).getStockiestName(), tpDetailedList.get(position).getJwName(), tpDetailedList.get(position).getSTPCode(), tpDetailedList.get(position).getSTPName()));

            if (!tpDetailedList.get(position).getWtName2().isEmpty())
                tpClickedList.add(new TpDetailedModel(tpDetailedList.get(position).getDayNo(), tpDetailedList.get(position).getWtName2(),  tpDetailedList.get(position).getHqName2(),tpDetailedList.get(position).getClusterName2(), tpDetailedList.get(position).getFWFlg2(), tpDetailedList.get(position).getDayRemarks2(), tpDetailedList.get(position).getDrName2(), tpDetailedList.get(position).getChemistName2(), tpDetailedList.get(position).getStockiestName2(), tpDetailedList.get(position).getJwName2(), tpDetailedList.get(position).getSTPCode(), tpDetailedList.get(position).getSTPName()));

            if (!tpDetailedList.get(position).getWtName3().isEmpty())
                tpClickedList.add(new TpDetailedModel(tpDetailedList.get(position).getDayNo(), tpDetailedList.get(position).getWtName3(),  tpDetailedList.get(position).getHqName3(),tpDetailedList.get(position).getClusterName3(), tpDetailedList.get(position).getFWFlg3(), tpDetailedList.get(position).getDayRemarks3(), tpDetailedList.get(position).getDrName3(), tpDetailedList.get(position).getChemistName3(), tpDetailedList.get(position).getStockiestName3(), tpDetailedList.get(position).getJwName3(), tpDetailedList.get(position).getSTPCode(), tpDetailedList.get(position).getSTPName()));
