...
import static saneforce.sanzen.activity.approvals.tp.TpApprovalActivity.SelectedDay;
...
public class TpApprovalDetailedAdapter extends RecyclerView.Adapter<TpApprovalDetailedAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TpApprovalDetailedAdapter.ViewHolder holder, int position) {
            ...
            tpClickedList.add(new TpDetailedModel(tpDetailedList.get(position).getDayNo(), tpDetailedList.get(position).getWtName(), tpDetailedList.get(position).getHqName(),tpDetailedList.get(position).getClusterName().replaceAll("\\$", ""), tpDetailedList.get(position).getFWFlg(), tpDetailedList.get(position).getDayRemarks(), tpDetailedList.get(position).getDrName().replaceAll("\\$", ""), tpDetailedList.get(position).getChemistName().replaceAll("\\$", ""), tpDetailedList.get(position).getStockiestName().replaceAll("\\$", ""), tpDetailedList.get(position).getJwName().replaceAll("\\$", ""), tpDetailedList.get(position).getSTPCode(), tpDetailedList.get(position).getSTPName()));

            if (!tpDetailedList.get(position).getWtName2().isEmpty())
                tpClickedList.add(new TpDetailedModel(tpDetailedList.get(position).getDayNo(), tpDetailedList.get(position).getWtName2(),  tpDetailedList.get(position).getHqName2(),tpDetailedList.get(position).getClusterName2().replaceAll("\\$", ""), tpDetailedList.get(position).getFWFlg2(), tpDetailedList.get(position).getDayRemarks2(), tpDetailedList.get(position).getDrName2().replaceAll("\\$", ""), tpDetailedList.get(position).getChemistName2().replaceAll("\\$", ""), tpDetailedList.get(position).getStockiestName2().replaceAll("\\$", ""), tpDetailedList.get(position).getJwName2().replaceAll("\\$", ""), tpDetailedList.get(position).getSTPCode2(), tpDetailedList.get(position).getSTPName2()));

            if (!tpDetailedList.get(position).getWtName3().isEmpty())
                tpClickedList.add(new TpDetailedModel(tpDetailedList.get(position).getDayNo(), tpDetailedList.get(position).getWtName3(),  tpDetailedList.get(position).getHqName3(),tpDetailedList.get(position).getClusterName3().replaceAll("\\$", ""), tpDetailedList.get(position).getFWFlg3(), tpDetailedList.get(position).getDayRemarks3(), tpDetailedList.get(position).getDrName3().replaceAll("\\$", ""), tpDetailedList.get(position).getChemistName3().replaceAll("\\$", ""), tpDetailedList.get(position).getStockiestName3().replaceAll("\\$", ""), tpDetailedList.get(position).getJwName3().replaceAll("\\$", ""), tpDetailedList.get(position).getSTPCode3(), tpDetailedList.get(position).getSTPName3()));
