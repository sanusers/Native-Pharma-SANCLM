...
public class AWSBuckets {
    ...
    private class AWSbucketsDownload extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... arg0) {
            try {
                TransferObserver downloadObserver = transferUtility.download("san.one","uploads"+ "/" + filestored_name+filename, file);
    ...
    private class AWSbucketsclass extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... arg0) {
            try {
                TransferObserver image_upload = transferUtility.upload("san.one","uploads"+ "/" + filestored_name+filename, file);
