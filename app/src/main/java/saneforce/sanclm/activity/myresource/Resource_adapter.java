...
import static saneforce.sanclm.activity.myresource.MyResource_Activity.Valcount;
import static saneforce.sanclm.activity.myresource.MyResource_Activity.appRecyclerView;
import static saneforce.sanclm.activity.myresource.MyResource_Activity.et_Custsearch;
import static saneforce.sanclm.activity.myresource.MyResource_Activity.listresource;
import static saneforce.sanclm.activity.myresource.MyResource_Activity.search_list;
...
//                                culst_val = jsonObject.getString("Code");
                    ...
                    case ("10"):
                        ...
                        listed = TimeUtils.GetConvertedDate(TimeUtils.FORMAT_4, TimeUtils.FORMAT_8, CommonUtilsMethods.getCurrentInstance());
